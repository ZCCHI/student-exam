                ...
                <div class="col-md-12 column">
                    <div class="panel panel-default" >
                                        ...
                                        <div class="col-md-12 column">
                                            <div class="panel panel-default">
                                                <div class="panel-body" style="padding:60px;">
                                                    <i class="glyphicon glyphicon-ok" style="color:green;font-size:40px;"></i> <span style="margin-left:20px;">你已成功报名！请你按时参加考试，遵守考场纪律</span>
                                                    <p style="margin-left:60px;">考试信息：你能在个人中心-已报考科目类型中查看</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="panel-footer" style="text-align:center;">
                            <button type="button" class="btn  btn-warning btn-lg" onclick="window.location.href='${APP_PATH}/member/member.htm'">个人中心</button>
                        </div>
                    </div>
                </div>
            </div>
