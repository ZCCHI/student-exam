  ...
  <body style="background-image: url(${APP_PATH }/img/beijing.jpg);background-size:100%;">
    ...
    <div class="container" style="padding-left:0px;width: 998px;">
      ...
      <form class="form-signin" role="form">
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-log-in"></i> 学生注册</h2>
         <div class="form-group has-success has-feedback">
			<input type="text" class="form-control" id="name" placeholder="请输入姓名" autofocus>
        ...
        <a class="btn btn-lg btn-success btn-block" href="#" onclick="register()" > 注册</a>
      </form>
    </div>
    ...
    function register() {    	
    	...
    	if($.trim(email.val()) == "" || $.trim(check.val()) == "" || $.trim(name.val()) == ""){
    	...
    	$.ajax({
    		...
    		beforeSend:function(){    			
    		loadingIndex = layer.msg('注册中', {icon: 16});   //开启提示信息   		
    			return true;
    		},
